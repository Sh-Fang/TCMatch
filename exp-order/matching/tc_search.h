...
public:
    ...
    void dynamic_generate_matching_order_NLF(IndexKeyItem &key,
    ...
    IndexKeyItem dynamic_get_next_order_NLF(IndexKeyItem &key,
                                        std::vector<IndexKeyItem> &_search_order,
                                        std::unordered_map<IndexKeyItem, std::vector<IndexValueItem>, IndexKeyItemHash> &global_index);


    void dynamic_generate_matching_order_GQL(IndexKeyItem &key,
                                             std::vector<IndexKeyItem> &_search_order,
                                             std::unordered_map<IndexKeyItem, std::vector<IndexValueItem>, IndexKeyItemHash> &global_index);

//    IndexKeyItem* dynamic_get_pre_order(const IndexKeyItem &,std::unordered_map<IndexKeyItem, std::vector<IndexValueItem>, IndexKeyItemHash> &global_index);
    IndexKeyItem dynamic_get_next_order(IndexKeyItem &key,
                                        std::vector<IndexKeyItem> &_search_order,
                                        std::unordered_map<IndexKeyItem, std::vector<IndexValueItem>, IndexKeyItemHash> &global_index);
