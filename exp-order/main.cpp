...
int main(int argc, char * argv[]){
    ...
    if(argc > 1){
        ...
        tc_arg->matching_order_type = "NLF";
    }
    ...
    tc_order->format_read_Q(tc_arg->path_of_query);
    ...
    //match order
    if(tc_arg->matching_order_type == "RI"){
        tc_order->build_search_order_with_RI(tc_io, tc_offline_index);
    }else if(tc_arg->matching_order_type == "GQL"){
