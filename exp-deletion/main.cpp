...
int main(int argc, char * argv[]){
    ...
    if(argc > 1){
        ...
        tc_arg->is_write_result = "n";
        tc_arg->is_print_for_experiment = "y";
        tc_arg->is_execute_deletion_experiment = "y";
    }
    ...
    if(tc_arg->is_execute_deletion_experiment == "y"){
        tc_global_index->deletion_process(tc_offline_index, tc_search, tc_order, tc_arg, tc_g_index, tc_io);
    } else if(tc_arg->is_execute_deletion_experiment == "n"){
