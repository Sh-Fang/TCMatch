...
void IO::load_stream_2_data_graph_and_update_graph(Arg *tc_arg) {
    ...
    //==============
    if(tc_arg->is_execute_deletion_experiment == "n"){
    ...
    } else if(tc_arg->is_execute_deletion_experiment == "y"){

//        uit del_data_num = S.size() * (1 - data_percent);
//
//        for(auto &it:S){
//            S_data.emplace_back(it);
//        }
...
//            if(edge_count++ < del_data_num){
//                S_delete.emplace_back(*it);
//            } else{
//                break;
//            }
//        }
