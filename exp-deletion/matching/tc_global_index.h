...
public:
    ...
    void delete_fht(IndexValueItem &value);
    ...
    bool deletion_process(OfflineIndex *tc_offline_index, Search *tc_search, MatchOrder *tc_order, Arg *tc_arg,
                        GIndex *tc_g_index, IO *tc_io);
    ...
    void delete_double_link(IndexValueItem &value);
