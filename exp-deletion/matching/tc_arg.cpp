...
int Arg::parse_arg(int argc, char **argv) {
    ...
    app.add_option("--ipo", is_print_output, "is print output [y/n] [default=y]")->default_val("y");
    app.add_option("--iwr", is_write_result, "is write result [y/n] [default=y]")->default_val("y");
    app.add_option("--ipfe", is_print_for_experiment, "is print log for experiment [y/n] [default=y]")->default_val("y");
    app.add_option("--iede", is_execute_deletion_experiment, "is execute deletion experiment [y/n] [default=y]")->default_val("y");
