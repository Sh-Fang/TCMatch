...
public:
    ...
    void only_struct_constrain(OfflineIndex *tc_offline_index, Search *tc_search, MatchOrder *tc_order, Arg *tc_arg,
                               GIndex *tc_g_index, IO *tc_io);

    void post_varify_time_constrain(OfflineIndex *tc_offline_index, Search *tc_search, MatchOrder *tc_order, Arg *tc_arg,
                                    GIndex *tc_g_index, IO *tc_io);
